          ...
          <div class="goodsDetail">
            ...
            <div class="support">
              ...
              <div class="supportArea">
                ...
                <div class="fixWidth">江西省 南昌市 高新区</div>
              </div>
            </div>
          </div>
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <button href="javascript:" class="mins" @click="mins">-</button>
              </div>
              <div class="add">
...
export default {
  ...
  methods: {
    changeChecked(AttrValue, AttrList) {
      AttrList.forEach((AttrValue) => {
